...
namespace TomaFoodRestaurant.DAL
{
    ...
    public class MySqlGatewayServerConnection
    {
        ...
        static string MainConnectionString = Properties.Settings.Default.connString + "password=" + Properties.Settings.Default.password + ";" + "Max Pool Size = 50000; Min Pool Size = 5;Charset=utf8;convert zero datetime=True";

        public MySqlTransaction Transaction { get; set; }
        public static bool IsServerConnected { get; set; }
        public MySqlGatewayServerConnection()
        {
            // string MainConnectionString = "server=127.0.0.1;user id=root;persistsecurityinfo=True;database=spiceresdb";
            try
            {
                string MainConnectionString = "server=" + Properties.Settings.Default.serverIp + ";user id=root; password=" + Properties.Settings.Default.password + ";database=" + Properties.Settings.Default.database + "; " + "Pooling=false; Max Pool Size = 50000; Min Pool Size = 5;Charset=utf8";
            ...
            {
                //    MessageBox.Show("Server is not conneted :"+ex.GetBaseException(), "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        {
            MainConnectionString = Properties.Settings.Default.connString + "password=" + Properties.Settings.Default.password + ";" + "Pooling=false; Max Pool Size = 50000; Min Pool Size = 5;Charset=utf8";
            Connection = new MySqlConnection(MainConnectionString);
            // Connection.Close();
            Connection.Open();
